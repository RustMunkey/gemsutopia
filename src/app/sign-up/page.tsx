...
export default function SignUp() {
  ...
  return (
    <div className="bg-black min-h-[200vh] flex flex-col">
      ...
      <div className="flex-grow py-16 flex items-center justify-center" style={{backgroundImage: 'url(/images/background.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed'}}>
