      ...
      <div className="flex-grow py-16 relative z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white/10">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">{getContent('information_collect_title')}</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">{getContent('why_use_title')}</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">{getContent('sharing_title')}</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">{getContent('transfers_title')}</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">{getContent('rights_title')}</h2>
