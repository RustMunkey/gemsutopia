...
function AboutPageEditor({ pageContents, onSave, onRefresh }: AboutPageEditorProps) {
  ...
  const contentMap = pageContents.reduce(
    (acc, item) => {
  ...
  const EditableText = ({
      ...
      return (
        <div className="relative">
          <textarea
            ...
            className={`resize-vertical min-h-[60px] w-full rounded border-2 border-yellow-400 bg-yellow-50 px-3 py-2 text-neutral-700 ${className}`}
            onKeyDown={e => {
          ...
          <div className="mt-2 flex items-center gap-2">
            ...
            >
              <IconDeviceFloppy size={12} className="mr-1 inline" />
              Save
            </button>
            <button
    ...
    return (
      <Component
        className={`${className} group relative cursor-pointer rounded px-2 py-1 transition-all hover:bg-blue-50 hover:outline-2 hover:outline-blue-300`}
      ...
      >
        ...
        <IconPencil
          size={12}
          className="ml-1 inline-block opacity-0 transition-opacity group-hover:opacity-50"
        />
      </Component>
    );
  };
  ...
  return (
    <div className="rounded-2xl bg-white/90 p-8 shadow-lg backdrop-blur-sm">
      ...
      <div className="prose prose-lg max-w-none text-neutral-700">
        <EditableText fieldKey="intro_paragraph" className="mb-8 text-xl leading-relaxed" />

        <EditableText fieldKey="paragraph_1" className="mb-6" />

        <EditableText fieldKey="paragraph_2" className="mb-6" />

        <EditableText fieldKey="paragraph_3" className="mb-6" />

        <EditableText fieldKey="paragraph_4" className="mb-8" />
        ...
        <ul className="mb-6">
          <li>
            <EditableText fieldKey="shipping_item_1" className="inline" tag="span" />
          </li>
          <li>
            <EditableText fieldKey="shipping_item_2" className="inline" tag="span" />
          </li>
          <li>
            <EditableText fieldKey="shipping_item_3" className="inline" tag="span" />
          </li>
        </ul>

        <EditableText fieldKey="shipping_note" className="mb-6" />

        <EditableText fieldKey="closing_paragraph" className="mb-8 text-xl leading-relaxed" />

        <EditableText fieldKey="signature" className="text-right font-semibold text-black" />
      </div>
    </div>
  );
}
    ...
    <div className="rounded-2xl bg-white/90 p-8 shadow-lg backdrop-blur-sm">
      <div className="mb-12 text-center">
        <EditableText
          ...
          tag="h1"
        />
        <EditableText fieldKey="subtitle" className="text-lg text-neutral-600" />
      </div>

      <div className="mb-12 grid grid-cols-1 gap-8 md:grid-cols-3">
        <div className="rounded-lg bg-white p-6 text-center shadow-sm">
          <IconMail size={48} className="mx-auto mb-4 text-black" />
          <EditableText
            fieldKey="email_support_title"
            className="mb-2 text-xl font-bold text-black"
            tag="h3"
          />
          <EditableText fieldKey="email_support_description" className="mb-4 text-neutral-600" />
          <EditableText
        ...
        <div className="rounded-lg bg-white p-6 text-center shadow-sm">
          <IconClock size={48} className="mx-auto mb-4 text-black" />
          <EditableText
            fieldKey="response_time_title"
            className="mb-2 text-xl font-bold text-black"
            tag="h3"
          />
          <EditableText fieldKey="response_time_description" className="mb-4 text-neutral-600" />
          <EditableText fieldKey="response_time_value" className="font-semibold text-black" />
        </div>

        <div className="rounded-lg bg-white p-6 text-center shadow-sm">
          <IconAlertCircle size={48} className="mx-auto mb-4 text-black" />
          <EditableText
            fieldKey="faq_title"
            className="mb-2 text-xl font-bold text-black"
            tag="h3"
          />
          <EditableText fieldKey="faq_description" className="mb-4 text-neutral-600" />
          <a href="#faq" className="font-semibold text-black hover:underline">
            View FAQ
          </a>
        </div>
      </div>
      ...
      <div id="faq">
        <EditableText
          ...
          className="mb-8 text-center text-2xl font-bold text-black"
          tag="h2"
        />
        <div className="space-y-6">
          <div className="rounded-lg bg-white p-6 shadow-sm">
            <EditableText
              ...
              tag="h3"
            />
            <EditableText fieldKey="faq_1_answer" className="text-neutral-600" />
          </div>
          ...
          <div className="rounded-lg bg-white p-6 shadow-sm">
            <EditableText
              ...
              tag="h3"
            />
            <EditableText fieldKey="faq_2_answer" className="text-neutral-600" />
          </div>
          ...
          <div className="rounded-lg bg-white p-6 shadow-sm">
            <EditableText
              ...
              tag="h3"
            />
            <EditableText fieldKey="faq_3_answer" className="text-neutral-600" />
          </div>
          ...
          <div className="rounded-lg bg-white p-6 shadow-sm">
            <EditableText
              ...
              tag="h3"
            />
            <EditableText fieldKey="faq_4_answer" className="text-neutral-600" />
          </div>
        </div>
      </div>
    </div>
          ...
          <textarea
            ...
            onKeyDown={e => {
              ...
              if (e.key === 'Enter' && (e.ctrlKey || e.metaKey))
                handleSave(getFieldId, onSave, onRefresh);
            }}
          />
          <div className="mt-2 flex items-center gap-2">
            <button
...
function TermsOfServicePageEditor({ pageContents, onSave, onRefresh }: AboutPageEditorProps) {
  ...
  const defaultContent: Record<string, string> = {
    ...
    products_paragraph_1:
      'Gemsutopia offers premium gemstones and minerals, many of which are hand-mined and ethically sourced from Alberta, Canada. All product descriptions, images, and specifications are provided to the best of our knowledge and ability.',
    products_paragraph_2:
    ...
    returns_content:
      'Please contact us at gemsutopia@gmail.com for detailed information about returns, exchanges, and refunds. All returns must be authorized and comply with our return policy.',
...
function PrivacyPolicyPageEditor({ pageContents, onSave, onRefresh }: AboutPageEditorProps) {
  ...
  const defaultContent: Record<string, string> = {
    ...
    why_use_item_4:
      'As necessary for my own legitimate interests, if those legitimate interests are not overridden by your rights or interests, such as (a) providing and enhancing my services;',
  ...
  return (
    <div className="rounded-2xl bg-white/90 p-8 shadow-lg backdrop-blur-sm">
      ...
      <div className="prose prose-lg max-w-none space-y-8 text-neutral-700">
        ...
        <section>
          <EditableText
            fieldKey="information_collect_title"
            className="mb-4 text-2xl font-bold text-black"
            tag="h2"
            getContent={getContent}
            getFieldId={getFieldId}
          ...
          />
          <EditableText
            fieldKey="information_collect_content"
            getContent={getContent}
            getFieldId={getFieldId}
            onSave={onSave}
            onRefresh={onRefresh}
        ...
        <section>
          ...
          <ul className="ml-6 list-disc space-y-4">
            <li>
              <strong>
                <EditableText
                  fieldKey="sharing_third_party_title"
                  className="inline"
                  tag="span"
                  getContent={getContent}
                  getFieldId={getFieldId}
              ...
              <EditableText
                fieldKey="sharing_third_party_content"
                className="inline"
                tag="span"
                getContent={getContent}
                getFieldId={getFieldId}
            ...
            <li>
              <strong>
                <EditableText
                  fieldKey="sharing_business_title"
                  className="inline"
                  tag="span"
                  getContent={getContent}
                  getFieldId={getFieldId}
              ...
              <EditableText
                fieldKey="sharing_business_content"
                className="inline"
                tag="span"
                getContent={getContent}
                getFieldId={getFieldId}
            ...
            <li>
              ...
              <EditableText
                fieldKey="sharing_legal_content"
                className="inline"
                tag="span"
                getContent={getContent}
                getFieldId={getFieldId}
        ...
        <section>
          ...
          <ul className="ml-6 list-disc space-y-3">
            <li>
              ...
              <EditableText
                fieldKey="rights_access_content"
                className="inline"
                tag="span"
                getContent={getContent}
                getFieldId={getFieldId}
            ...
            <li>
              ...
              <EditableText
                fieldKey="rights_change_content"
                className="inline"
                tag="span"
                getContent={getContent}
                getFieldId={getFieldId}
            ...
            <li>
              ...
              <EditableText
                fieldKey="rights_object_content"
                className="inline"
                tag="span"
                getContent={getContent}
                getFieldId={getFieldId}
            ...
            <li>
              <strong>
                <EditableText
                  fieldKey="rights_complain_title"
                  className="inline"
                  tag="span"
                  getContent={getContent}
                  getFieldId={getFieldId}
              ...
              <EditableText
                fieldKey="rights_complain_content"
                className="inline"
                tag="span"
                getContent={getContent}
                getFieldId={getFieldId}
...
function CookiePolicyPageEditor({ pageContents, onSave, onRefresh }: AboutPageEditorProps) {
  ...
  const defaultContent: Record<string, string> = {
    ...
    how_use_essential:
      'Essential Cookies: Required for basic website functionality, shopping cart, and checkout process',
    how_use_performance:
    ...
    managing_optout:
      'Opt-Out: You can opt-out of certain cookies, though this may affect website functionality',
    managing_note:
      ...
      <div className="prose prose-lg max-w-none space-y-8 text-neutral-700">
        ...
        <section>
          ...
          <ul className="ml-6 list-disc space-y-2">
            <li>
              <EditableText
                fieldKey="third_party_analytics"
                className="inline"
                tag="span"
                getContent={getContent}
                getFieldId={getFieldId}
        ...
        <section>
          ...
          <ul className="ml-6 list-disc space-y-2">
            ...
            <li>
              <strong>
                <EditableText
                  fieldKey="retention_essential_time"
                  className="inline"
                  tag="span"
                  getContent={getContent}
                  getFieldId={getFieldId}
            ...
            <li>
              <strong>
                <EditableText
                  fieldKey="retention_analytics_time"
                  className="inline"
                  tag="span"
                  getContent={getContent}
                  getFieldId={getFieldId}
...
function CookieSettingsPageEditor({ pageContents, onSave, onRefresh }: AboutPageEditorProps) {
  ...
  const defaultContent: Record<string, string> = {
    ...
    intro_text:
      'We use cookies to enhance your browsing experience, provide personalized content, and analyze our traffic. You can customize your cookie preferences below. Please note that disabling certain cookies may impact your experience on our website.',
    ...
    marketing_description:
      'These cookies track your browsing activity to help us show you relevant advertisements and measure the effectiveness of our marketing campaigns. They may be set by us or third-party advertising partners.',
    functional_title: 'Functional Cookies',
    functional_description:
      'These cookies enable enhanced functionality and personalization, such as remembering your preferences and settings. They may be set by us or by third-party providers whose services we use on our pages.',
  ...
  return (
    <div className="rounded-2xl bg-white/90 p-8 shadow-lg backdrop-blur-sm">
      ...
      <div className="space-y-8 rounded-lg bg-white p-8 shadow-sm">
        ...
        <div className="border-b border-neutral-200 pb-6">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex-1">
              ...
              />
              <EditableText
                fieldKey="essential_description"
        ...
        <div className="border-b border-neutral-200 pb-6">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex-1">
              ...
              />
              <EditableText
                fieldKey="analytics_description"
                className="text-sm text-neutral-600"
                getContent={getContent}
                getFieldId={getFieldId}
                onSave={onSave}
            ...
            <div className="ml-6">
              <label className="relative inline-flex cursor-pointer items-center">
                ...
                <div className="peer h-6 w-11 rounded-full bg-gray-200 peer-checked:bg-green-600 peer-focus:outline-none after:absolute after:top-[2px] after:left-[2px] after:h-5 after:w-5 after:rounded-full after:bg-white after:transition-all after:content-[''] peer-checked:after:translate-x-full peer-checked:after:border-white"></div>
              </label>
            </div>
          </div>
        </div>
        ...
        <div className="border-b border-neutral-200 pb-6">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex-1">
              ...
              />
              <EditableText
                fieldKey="marketing_description"
                className="text-sm text-neutral-600"
                getContent={getContent}
                getFieldId={getFieldId}
                onSave={onSave}
        ...
        <div className="pb-6">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex-1">
              ...
              />
              <EditableText
                fieldKey="functional_description"
                className="text-sm text-neutral-600"
                getContent={getContent}
                getFieldId={getFieldId}
                onSave={onSave}
        ...
        {/* Action Buttons */}
        <div className="flex flex-col gap-4 border-t border-neutral-200 pt-6 sm:flex-row">
          <button className="rounded-lg bg-black px-6 py-3 font-semibold text-white transition-colors hover:bg-neutral-800">
            <EditableText
              fieldKey="save_button"
              className="inline"
              tag="span"
              getContent={getContent}
              getFieldId={getFieldId}
          ...
          <button className="rounded-lg bg-neutral-200 px-6 py-3 font-semibold text-black transition-colors hover:bg-neutral-300">
            <EditableText
              fieldKey="accept_all_button"
              className="inline"
              tag="span"
              getContent={getContent}
              getFieldId={getFieldId}
    ...
    <div className="space-y-6">
      <div className="rounded-2xl border border-white/20 bg-black p-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="mb-2 text-2xl font-bold text-white">Page Management ✨</h1>
          ...
          <button
            ...
            className={`rounded-2xl border p-6 text-left transition-all ${
              selectedPage === page.id
                ? mode === 'dev'
                  ? 'border-orange-500/20 bg-gradient-to-br from-orange-500/10 to-orange-600/5 text-white'
                  : 'border-blue-500/20 bg-gradient-to-br from-blue-500/10 to-blue-600/5 text-white'
                ...
                <div key={field.id} className="rounded-lg border border-white/10 bg-white/5 p-4">
                  ...
                  {editingField === field.id ? (
                    <textarea
                      ...
                      className="resize-vertical h-32 w-full rounded border border-white/20 bg-black px-3 py-2 text-white"
                ...
                <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                  <div className="mb-4 flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 rounded border border-white/20 bg-black px-3 py-2 text-white"
                    />
                    <button
                      onClick={addField}
                    ...
                    <button
                      ...
                      className="rounded bg-slate-600 px-4 py-2 text-white transition-colors hover:bg-slate-700"
                    >
                      Cancel
                    </button>
                  </div>
